...
export function NeuralNoise({ color = [0.93, 0.28, 0.6], opacity = 0.5, speed = 0.001 }) {
  ...
  useEffect(() => {
    ...
    const resizeListener = () => resizeCanvas(gl);
  ...
  function render(gl) {
    ...
    gl.uniform2f(uniformsRef.current.u_pointer_position, pointer.x / window.innerWidth, 1 - pointer.y / window.innerHeight);
    gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
    animationRef.current = requestAnimationFrame(() => render(gl));
  }
